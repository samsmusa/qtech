...
class Category(TimeStampMixin):
    ...
    image = models.ManyToManyField(FileManager, related_name='category', blank=True)
...
class Product(TimeStampMixin):
    ...
    image = models.ManyToManyField(FileManager, related_name='product', blank=True)
